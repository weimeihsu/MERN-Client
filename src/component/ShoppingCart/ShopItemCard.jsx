...
const ShopItemCard = (item) => {
    ...
    const handleSubmit = (e, snackState) => {
        e.preventDefault()
        const theItem = { 
        ...
        setSnackbarState({...snackState, open: true})
        dispatch(sumCost())
        setBuyCount(1)
    }
            ...
            <CardActions>
                <Stack spacing={2} direction="column" alignItems="flex-end">
                    ...
                    <Stack spacing={2} direction="row">
                        ...
                        <Button onClick={(e)=>handleSubmit(e, { vertical: 'top', horizontal: 'center' })} sx={{marginLeft:1}} type='submit' size="small" variant="contained" color="secondary">Add to Cart</Button>
                        <Snackbar
